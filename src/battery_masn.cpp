// ============================================================================
// battery_masn.cpp — lettura VBAT su MASN (NiceNano nRF52840 + HT-RA62).
...
//   di MASN sul BMS/circuito di ricarica solare. Vanno calibrati con un
...
// PLACEHOLDER: nessuna compensazione di partitore nota per MASN (assume
// lettura diretta o partitore 1:1). Da correggere dopo verifica hardware.
