// ============================================================================
// variant.h — variant PlatformIO locale e minimale per schede DIY nRF52840 in
//   formato Pro-Micro/NiceNano con modulo LoRa HT-RA62 (SX1262). Condivisa da
//   più board di questo progetto (MASN — src/board_config.h BOARD_MASN_HTRA62
//   — e FakeTec — BOARD_FAKETEC), che instradano il modulo HT-RA62 secondo lo
//   stesso schema community "nRF52 Pro-micro DIY". Scritta da zero per questo
//   progetto (licenza MIT), NON copiata dal firmware Meshtastic (GPL-3.0) ne'
//   da altri pacchetti board di terzi.
//
...
//   PIN_LORA_*/PIN_VBAT_READ definite in src/board_config.h (blocchi
//   BOARD_MASN_HTRA62 / BOARD_FAKETEC) indirizzano esattamente la GPIO fisica
//   voluta, senza passare da un alias "Dx" specifico di una scheda di terzi
//   che potrebbe non corrispondere al pinout reale della board in uso.
//
...
//   su nessuna delle due board reali (MASN/FakeTec) — vedi i commenti nei
//   rispettivi blocchi di board_config.h.
// ============================================================================
#ifndef _NRF52_PROMICRO_DIY_HTRA62_VARIANT_H_
#define _NRF52_PROMICRO_DIY_HTRA62_VARIANT_H_
...
// Se il modulo usato monta invece un quarzo LF, cambiare in USE_LFXO.
#define USE_LFRC
...
// Nessun LED/pulsante generico noto e verificato per queste board in questa
// variant definition: main.cpp/led_status.cpp restano disattivati (nessun
// PIN_BUTTON/HAS_STATUS_LED nei blocchi board_config.h corrispondenti).
...
// board_config.h (BOARD_MASN_HTRA62 / BOARD_FAKETEC), perche' radio.cpp usa
// SPI.begin() senza argomenti su nRF52.
...
#endif // _NRF52_PROMICRO_DIY_HTRA62_VARIANT_H_
